  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (type$.Element._is(gameContainer)) {
        ...
        new A.ChessBoard(t2, new A.ChessGame(gameContainer), gameContainer).insertTiles$0();
        t1.querySelector(".colour-switcher");
        t1.getElementById("piece-box");
      }
    }
  },
  J = {
