...
(function dartProgram() {
  ...
  A.ChessGame.prototype = {
    submitMove$2(i, j) {
      ...
      t1 = piece.colour === t1;
      if (t1) {
        options = piece.moveStrategy.move$2(_this.__ChessGame_chessBoard_A, piece);
    ...
    validMove$2(i, j) {
      var t1, t2, _i, move;
      A.print("checking for move[" + i + "][" + j + "] in " + this.options.length + " options");
