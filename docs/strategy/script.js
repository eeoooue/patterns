  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (t2._is(gameContainer)) {
        ...
        mimic = new A.MimicPiece(4, 3, new A.QueenMovement());
        ...
        if (type$.ImageElement._is(img)) {
          ...
          mimic.__GamePiece_element_A = img;
          t1 = img;
        } else
          t1 = $;
        ...
        if (4 >= t2.length)
          return A.ioore(t2, 4);
        B.JSArray_methods.$indexSet(t2[4], 3, mimic);
      }
    }
  },
  J = {
