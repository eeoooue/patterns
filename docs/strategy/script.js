...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    BlackPawn: function BlackPawn() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    BlackKnight: function BlackKnight() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    BlackBishop: function BlackBishop() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    BlackRook: function BlackRook() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    BlackKing: function BlackKing() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    BlackQueen: function BlackQueen() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    Game: function Game() {
    },
    ...
    main() {
      var t3, switchBtn, pieceContainer,
        t1 = document,
    ...
    WhitePawn: function WhitePawn() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    WhiteKnight: function WhiteKnight() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    WhiteBishop: function WhiteBishop() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    WhiteRook: function WhiteRook() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    WhiteKing: function WhiteKing() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    WhiteQueen: function WhiteQueen() {
      this.__GamePiece_element_A = this.__GamePiece_src_A = $;
    },
    printString(string) {
  ...
  A.PieceBox.prototype = {
    ...
    presentPieces$0() {
      ...
      options = J.JSArray_JSArray$growable(0, type$.ChessPiece);
      B.JSArray_methods.add$1(options, _this.factory.createPawn$0());
      B.JSArray_methods.add$1(options, _this.factory.createBishop$0());
      B.JSArray_methods.add$1(options, _this.factory.createKnight$0());
      B.JSArray_methods.add$1(options, _this.factory.createRook$0());
      B.JSArray_methods.add$1(options, _this.factory.createQueen$0());
      B.JSArray_methods.add$1(options, _this.factory.createKing$0());
      t3 = options.length;
      _i = 0;
      for (; _i < options.length; options.length === t3 || (0, A.throwConcurrentModificationError)(options), ++_i) {
        piece = options[_i];
        t4 = t2.get$children(t1);
        t5 = piece.__GamePiece_element_A;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.ChessBoard_createTile_closure, A.PieceBox_armButton_closure]);
    ...
    _inheritMany(A.ChessPiece, [A.Pawn, A.Knight, A.Bishop, A.Rook, A.King, A.Queen]);
